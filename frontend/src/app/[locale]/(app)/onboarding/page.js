              ...
              <div className="w-full space-y-6">
                ...
                {waLink && (
                  <a
                    ...
                    className="flex items-center justify-center gap-3 w-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium py-3.5 px-6 rounded-[var(--radius-btn)] transition-colors text-sm"
                  >
