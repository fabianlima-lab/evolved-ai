...
export default function StatBar({ label, value, max = 5 }) {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 h-2 bg-elevated rounded-[var(--radius-card)] overflow-hidden">
        <div
          className="h-full rounded-[var(--radius-card)] transition-all duration-700 ease-out bg-accent"
          style={{ width: `${pct}%` }}
        />
      </div>
